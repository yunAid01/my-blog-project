          ...
          <div className="text-white flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-1">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
                <path
                  fillRule="evenodd"
                  d="M18 10c0 3.866-3.582 7-8 7a8.864 8.864 0 01-4.083-.98L2 17l1.03-3.09A8.952 8.952 0 012 10c0-3.866 3.582-7 8-7s8 3.134 8 7zM4.5 10a6.5 6.5 0 1113 0 6.5 6.5 0 01-13 0z"
                  clipRule="evenodd"
                ></path>
              </svg>
