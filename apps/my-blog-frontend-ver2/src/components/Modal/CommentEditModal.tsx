...
export default function CommentEditModal({
  ...
  const { mutate: updateCommentAction, isPending: isUpdating } = useMutation({
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex justify-end pt-4">
            <button
              ...
              className="px-6 py-2 bg-blue-500 text-white rounded-lg font-bold hover:bg-blue-600 disabled:bg-blue-300"
            >
              {isUpdating ? '저장 중...' : '저장'}
            </button>
          </div>
